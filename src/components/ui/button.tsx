  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "border border-mui-text-primary/[0.0023] bg-transparent text-mui-text-primary hover:bg-gray-100 focus:bg-gray-200 focus-visible:bg-gray-100",
        ...
        "outline-secondary": "border border-mui-text-primary/[0.0023] bg-transparent text-mui-text-primary hover:bg-gray-100 hover:text-mui-text-primary",
        ...
        "text-secondary": "bg-transparent text-mui-text-primary hover:bg-gray-100 hover:text-mui-text-primary",
