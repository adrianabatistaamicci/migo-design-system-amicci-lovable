...
const ComponentCard: React.FC<ComponentCardProps> = ({
  ...
  return <div className={cn("rounded-lg border border-gray-200 bg-white overflow-hidden transition-all duration-250 animate-fade-in shadow-sm h-full flex flex-col", className)}>
      ...
      maxHeight: 200
    }} className="p-5 flex items-center justify-center flex-grow overflow-y-auto py-[20px]">
