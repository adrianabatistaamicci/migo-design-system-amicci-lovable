            ...
            <div className="flex flex-1 items-center space-x-4">
              ...
              <div className="w-full max-w-md">
                <div className="relative">
                  ...
                  <input type="text" className="block w-full rounded-md border-0 bg-white/10 py-1.5 pl-10 pr-3 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-white sm:text-sm sm:leading-6" placeholder="Buscar" />
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <IconButton variant="outline-secondary" icon={<Bell size={18} />} aria-label="Ver notificações" />
              <ProfileButton userName="Maria Silva" companyName="Empresa Ltda." showMenuIcon={false} />
            </div>
          </div>
        </>} headerContent={<div className="mx-auto max-w-7xl">
...
export const LightBorderExample = () => {
  return <StackedLayout variant="light-border" headerClassName="bg-white" navigationContent={<>
...
export const MarketplaceExample = () => {
  return <StackedLayout variant="light-border" mainClassName="bg-white" headerClassName="bg-white" navigationContent={<>
          ...
          <div className="flex items-center space-x-4">
            ...
            <ProfileButton userName="Amanda Silva" companyName="Empresa XYZ" showClientLogo={false} avatarText="AS" showMenuIcon={false} />
          </div>
