    ...
    <div className="w-full animate-fade-in">
      ...
      <div className="mt-8 grid grid-cols-1 gap-8">
        <div className="w-full bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-medium mb-4">Lista de notificações</h3>
          ...
          <CodeBlock 
            ...
            language="tsx"
            title="Implementação da Lista de Notificações"
            showCode={false}
          />
        </div>
        ...
        <div className="w-full bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          <CodeBlock 
            ...
            language="tsx"
            title="Implementação da Lista de Usuários"
            showCode={false}
          />
        </div>
        ...
        <div className="w-full bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-medium mb-4">Lista de configurações</h3>
            <div className="p-6 max-w-2xl mx-auto w-full">
              <div className="divide-y divide-gray-200">
                <div className="py-4 flex justify-between items-center">
                  <div className="flex items-center">
          ...
          <CodeBlock 
            ...
            language="tsx"
            title="Implementação da Lista de Configurações"
            showCode={false}
          />
        </div>
      </div>
