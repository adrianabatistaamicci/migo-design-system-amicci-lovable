                ...
                <div className="grid grid-cols-1 md:grid-cols-10 gap-6">
                  <Card className="p-6 md:col-span-7 shadow-none border">
                    ...
                    <div className="grid grid-cols-3 gap-4l">
                      ...
                      <div className="flex flex-col items-center gap-4">
                        <div className="border rounded-lg p-4 w-full h-48 flex items-center justify-center bg-white">
                          <img src={Amy002} alt="Amy, a IA da Amicci em outra pose" className="max-h-full object-contain" />
                        </div>
                      ...
                      <div className="flex flex-col items-center gap-4">
                        <div className="border rounded-lg p-4 w-full h-48 flex items-center justify-center bg-white">
                          <img src={Amy004} alt="Amy, avatar em formato de perfil" className="max-h-full object-contain" />
                        </div>
