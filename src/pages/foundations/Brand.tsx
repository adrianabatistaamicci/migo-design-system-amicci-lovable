    ...
    <div className="w-full animate-fade-in">
      ...
      <TailwindTabs 
        ...
        tabs={[
          ...
          { name: 'Variações', value: 'variations' },
      ...
      {activeTab === 'usage' && (
        <div className="mt-6">
          <ComponentCard title="Diretrizes de Uso" description="Como aplicar nossa marca de forma consistente">
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-medium mb-4">Áreas de proteção</h3>
                <p className="text-gray-600 mb-4">
                  Mantenha sempre um espaço livre ao redor do logotipo, equivalente à altura da letra "a" do logotipo.
                </p>
              </div>
              
              <div>
                <h3 className="text-xl font-medium mb-4">Usos incorretos</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  <li>Não distorça ou altere as proporções do logotipo</li>
                  <li>Não use cores diferentes das especificadas no manual</li>
                  <li>Não aplique sombras ou efeitos ao logotipo</li>
                  <li>Não rotacione ou inverta o logotipo</li>
                  <li>Não coloque o logotipo sobre fundos que comprometam sua visibilidade</li>
                </ul>
              </div>
              
              <div>
                <h3 className="text-xl font-medium mb-4">Aplicações</h3>
                <p className="text-gray-600">
                  O logotipo pode ser aplicado em materiais impressos, digitais, sinalização e brindes, seguindo sempre as diretrizes estabelecidas neste manual.
                </p>
              </div>
            </div>
          </ComponentCard>
