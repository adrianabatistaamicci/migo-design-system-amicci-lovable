...
const paletteData = [
  ...
  },
  {
    ...
    variants: [
      ...
      { name: 'contrast', colorClass: 'bg-success-contrast', baseColor: 'common-white-main', textColor: 'text-success-main', hexValue: '#FFFFFF' },
  ...
  },
  {
    ...
    description: 'Red',
    variants: [
      { name: 'main', colorClass: 'bg-error-main', baseColor: 'red-500', textColor: 'text-error-contrast', hexValue: '#F04438' },
      { name: 'dark', colorClass: 'bg-error-dark', baseColor: 'red-700', textColor: 'text-error-contrast', hexValue: '#B42318' },
      { name: 'light', colorClass: 'bg-error-light', baseColor: 'red-100', textColor: 'text-black', hexValue: '#FEE4E2' },
      { name: 'contrast', colorClass: 'bg-error-contrast', baseColor: 'common-white-main', textColor: 'text-error-main', hexValue: '#FFFFFF' },
      ...
      { name: 'focusVisible', colorClass: 'bg-error-focusVisible', baseColor: 'red-500', textColor: 'text-black', opacity: '30%', hexValue: '#F044384D' },
      { name: 'outlinedBorder', colorClass: 'bg-error-outlinedBorder', baseColor: 'red-500', textColor: 'text-black', opacity: '50%', hexValue: '#F0443880' }
    ]
  },
  {
    name: 'Warning',
    description: 'Orange',
    variants: [
      { name: 'main', colorClass: 'bg-warning-main', baseColor: 'orange-500', textColor: 'text-warning-contrast', hexValue: '#F79009' },
      { name: 'dark', colorClass: 'bg-warning-dark', baseColor: 'orange-700', textColor: 'text-warning-contrast', hexValue: '#B54708' },
      { name: 'light', colorClass: 'bg-warning-light', baseColor: 'orange-100', textColor: 'text-black', hexValue: '#FEF0C7' },
      { name: 'contrast', colorClass: 'bg-warning-contrast', baseColor: 'common-white-main', textColor: 'text-warning-main', hexValue: '#FFFFFF' },
      ...
      { name: 'focusVisible', colorClass: 'bg-warning-focusVisible', baseColor: 'orange-500', textColor: 'text-black', opacity: '30%', hexValue: '#F790094D' },
      { name: 'outlinedBorder', colorClass: 'bg-warning-outlinedBorder', baseColor: 'orange-500', textColor: 'text-black', opacity: '50%', hexValue: '#F7900980' }
    ]
  },
  {
    name: 'Info',
    description: 'Blue',
    variants: [
      { name: 'main', colorClass: 'bg-info-main', baseColor: 'blue-500', textColor: 'text-info-contrast', hexValue: '#2970FF' },
      { name: 'dark', colorClass: 'bg-info-dark', baseColor: 'blue-700', textColor: 'text-info-contrast', hexValue: '#0057B2' },
      { name: 'light', colorClass: 'bg-info-light', baseColor: 'blue-100', textColor: 'text-black', hexValue: '#D6E8FF' },
      { name: 'contrast', colorClass: 'bg-info-contrast', baseColor: 'common-white-main', textColor: 'text-info-main', hexValue: '#FFFFFF' },
      ...
      { name: 'focusVisible', colorClass: 'bg-info-focusVisible', baseColor: 'blue-500', textColor: 'text-black', opacity: '30%', hexValue: '#2970FF4D' },
      { name: 'outlinedBorder', colorClass: 'bg-info-outlinedBorder', baseColor: 'blue-500', textColor: 'text-black', opacity: '50%', hexValue: '#2970FF80' }
    ]
  }
];

// Create a ColorExample component for demonstrating
const ColorExample = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold">Examples</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <ComponentCard title="Color Paletas Tema">
          <div className="grid grid-cols-5 gap-2">
            <ColorSwatch color="bg-primary-main" textOverlay="Primary" className="h-16" />
            <ColorSwatch color="bg-secondary-main" textOverlay="Secondary" className="h-16" />
            <ColorSwatch color="bg-tertiary-main" textOverlay="Tertiary" className="h-16" />
            <ColorSwatch color="bg-error-main" textOverlay="Error" className="h-16" />
            <ColorSwatch color="bg-success-main" textOverlay="Success" className="h-16" />
          </div>
        </ComponentCard>
...
// Colors component (main export)
const Colors = () => {
  return (
    <div className="container pb-16">
      <div className="py-10">
        <h1 className="text-4xl font-bold">Cores</h1>
        <p className="text-lg text-gray-600 mt-2">
          Paleta de cores completa para o design system.
        </p>
      </div>
      ...
      <Tabs defaultValue="examples">
        ...
        <TabsContent value="base">
          <div className="space-y-10">
            <h2 className="text-2xl font-bold">Cores Base</h2>
            <p className="text-gray-600">
              Estas são as cores base utilizadas para criar todas as paletas temáticas.
            </p>
        ...
        <TabsContent value="palette">
          <div className="space-y-10">
            <h2 className="text-2xl font-bold">Paletas Temáticas</h2>
            <p className="text-gray-600">
              As paletas semânticas são derivadas das cores base e oferecem variações para diferentes contextos de UI.
            </p>
