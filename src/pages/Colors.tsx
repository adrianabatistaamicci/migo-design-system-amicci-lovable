            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`magenta-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 400 ? 'text-white' : 'text-black'} flex items-end p-2 bg-magenta-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`blue-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 400 ? 'text-white' : 'text-black'} flex items-end p-2 bg-blue-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`green-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 600 ? 'text-white' : 'text-black'} flex items-end p-2 bg-green-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`red-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 300 ? 'text-white' : 'text-black'} flex items-end p-2 bg-red-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`yellow-${weight}`} className="flex flex-col">
                  <div 
                    className="h-16 rounded-t-md text-black flex items-end p-2 bg-yellow-${weight}"
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`amber-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 800 ? 'text-white' : 'text-black'} flex items-end p-2 bg-amber-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`orange-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 500 ? 'text-white' : 'text-black'} flex items-end p-2 bg-orange-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              {[50, 100, 200, 300, 400, 500, 600, 700, 800, 900].map((weight, index) => (
                <div key={`gray-${weight}`} className="flex flex-col">
                  <div 
                    className={`h-16 rounded-t-md ${weight >= 600 ? 'text-white' : 'text-black'} flex items-end p-2 bg-gray-${weight}`}
                  >
                    {weight}
                  </div>
                  <div className="p-2 border border-t-0 rounded-b-md text-sm">
