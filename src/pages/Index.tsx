  ...
  return <div className="space-y-16">
      <section className="max-w-7xl mx-auto px-0">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-gray-800">Migo, o Design System da Amicci</h2>
          <h6 className="text-lg text-gray-600 mb-8">Um sistema de design Tailwind consistente para criar interfaces de usuário modernas e acessíveis com React.</h6>
      ...
      <section>
        <div className="max-w-7xl mx-auto px-4">
          <h5 className="text-xl md:text-2xl font-semibold tracking-tight mb-8 text-gray-800">
            Recursos principais
          </h5>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h6 className="text-base font-semibold mb-2 text-gray-800">Instalação</h6>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h6 className="text-base font-semibold mb-2 text-gray-800">Diretrizes</h6>
              <p className="text-sm text-gray-600 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h6 className="text-base font-semibold mb-2 text-gray-800">UI Kit</h6>
              <p className="text-sm text-gray-600 mb-4">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h6 className="text-base font-semibold mb-2 text-gray-800">Recursos</h6>
              <p className="text-sm text-gray-600 mb-4">
