      ...
      <div className="mt-6">
        ...
        <div className="mt-8">
          ...
          {activeTab === 'projetos' && <div className="space-y-8">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <h2 className="text-2xl font-semibold mb-6">Remix deste projeto</h2>
                <p className="mb-4">Para iniciar rapidamente seus experimentos com o Migo Design System, recomendamos criar um remix deste projeto:</p>
                
                <div className="space-y-6 mt-6">
                  <div className="bg-white p-5 rounded-md shadow-sm border border-gray-100">
                    <h3 className="text-xl font-semibold mb-4">Como criar um remix:</h3>
                    <ol className="list-decimal pl-6 space-y-2 mb-4">
                      <li>Abra o projeto atual na plataforma Lovable</li>
                      <li>Clique no nome do projeto no topo da interface</li>
                      <li>Selecione "Remix" para criar uma cópia do projeto</li>
                      <li>Dê um nome ao seu novo projeto</li>
                      <li>Comece a trabalhar em sua própria versão do Design System</li>
                    </ol>
                    
                    <div className="bg-primary-50 p-4 rounded border border-primary-200 mt-4">
                      <p className="text-sm text-primary-700"><strong>Nota:</strong> Ao criar um remix, você terá uma cópia completa do projeto que poderá ser personalizada conforme suas necessidades, sem afetar o projeto original.</p>
                    </div>
                  </div>
                </div>
              </div>
